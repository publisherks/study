...
(function (global, factory) {
            ...
            const diagScriptFun = function diagScriptFun(nodeUnderTestId, testIconId, md5, parentOrigin) {
                parent.FontAwesomeDetection.__pollUntil({
                    fn: function fn() {
                        ...
                        if (Boolean(fontFamily.match(/FontAwesome/)) || Boolean(fontFamily.match(/Font Awesome [56]/))) {
                            return true;
                        }
                        return false;
                    },
    ...
    function detectSvgConflicts(currentScript) {
        ...
        const _loop = function _loop(scriptIdx) {
            ...
            const diagScriptFun = function diagScriptFun(nodeUnderTestId, md5, parentOrigin) {
                parent.FontAwesomeDetection.__pollUntil({
                    fn: function fn() {
                        return Boolean(window.FontAwesomeConfig) || Boolean(window.FontAwesomeKitConfig);
                    },
                }).then(() => {
    ...
    const _default = {
        report,
        timeout: Number(DOCUMENT.currentScript.getAttribute(timeoutAttr) || '2000'),
        resultsCollectionMaxWait: Number(DOCUMENT.currentScript.getAttribute(resultsCollectionMaxWaitAttr) || '5000'),
    };
